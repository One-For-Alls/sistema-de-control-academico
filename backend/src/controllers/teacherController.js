...
const registerTeacherController = async (req, res) => {
  const { academicDegree, yearOfExperience, hireDate, userId } = req.body
  try {
    const newTeacher = await registerTeacher({ academicDegree, yearOfExperience, hireDate, userId })
...
const updateTeacherController = async (req, res) => {
  ...
  const { academicDegree, yearOfExperience, hireDate, userId } = req.body
  try {
    const updatedTeacher = await updateTeacher(id, { academicDegree, yearOfExperience, hireDate, userId })
